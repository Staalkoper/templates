...
<?php include TEMPLATE_DIR . "header.php"; ?>
    ...
    <div class="edit" rel="aboutus" field="aboutus" data-mw="main">
        ...
        <div class="container content">
            ...
            <module type="pictures" id="picsliderbig"/>
            </div>
            <!-- End About Sldier -->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-sm-4">
                            <img alt="" src="<?php print TEMPLATE_URL;?>assets/img/main/6.jpg" class="img-responsive margin-bottom-20">
                        </div>
                        <div class="col-sm-8">
...
<module type="paralaxblock" id="paralaxblockaboutus1" template="team3"/>
        ...
        <div class="container content">
            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-3 col-sm-6 md-margin-bottom-20">
                    <div class="simple-block">
                        <img class="img-responsive img-bordered" src="<?php print TEMPLATE_URL;?>assets/img/job/high-rated-job-1.3.jpg" alt="">
                ...
                <div class="col-md-3 col-sm-6 md-margin-bottom-20">
                    <div class="simple-block">
                        <img class="img-responsive img-bordered" src="<?php print TEMPLATE_URL;?>assets/img/job/high-rated-job-2.3.jpg" alt="">
                        <p>Pellentesque et erat ac massa cursus porttitor eget sed magna.</p>
                    </div>
                </div>
                <!-- End Simple Block -->
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 md-margin-bottom-20">
                    <div class="simple-block">
                        <img class="img-responsive img-bordered" src="<?php print TEMPLATE_URL;?>assets/img/job/high-rated-job-1.jpg" alt="">
                        <p>Pellentesque et erat ac massa cursus porttitor eget sed magna.</p>
                    </div>
                </div>
                <!-- End Simple Block -->
                ...
                <div class="col-md-3 col-sm-6 md-margin-bottom-20">
                    <div class="simple-block">
                        <img class="img-responsive img-bordered" src="<?php print TEMPLATE_URL;?>assets/img/job/high-rated-job-2.2.jpg" alt="">
                        <p>Pellentesque et erat ac massa cursus porttitor eget sed magna.</p>
                    </div>
                </div>
                <!-- End Simple Block -->
                ...
                <div class="col-md-3 col-sm-6 md-margin-bottom-20">
                    <div class="simple-block">
                        <div class="responsive-video">
                            <iframe frameborder="0" allowfullscreen="" mozallowfullscreen="" webkitallowfullscreen="" src="<?php print TEMPLATE_URL;?>//player.vimeo.com/video/70528799"></iframe>
                        </div>
                        <p>Pellentesque et erat ac massa cursus porttitor eget sed magna.</p>
                    </div>
                </div>
        ...
        <div class="container content our-location">
            <div class="title-box-v2">
                <h2>Contact <span class="color-green">Us</span></h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
            ...
            <div class="row margin-bottom-30">
                <div class="col-md-8 text-justify md-margin-bottom-20">
                    ...
                    <p>Aenean iaculis risus ligula, interdum pellentesque ante sollicitudin at. Proin et placerat quam. Vivamus sagittis luctus ipsum, ac auctor nibh interdum malesuada. Ut ut eros nibh. Sed dignissim vehicula metus eget feugiat.</p><br>
                ...
                <div class="col-md-4">
                    <!-- Google Map -->
                    <div id="map" class="map margin-bottom-40"></div>
                    <!-- End Google Map -->
            ...
            <div class="owl-carousel-style-v2">
                ...
                <module type="pictures" id="aboutusslider" template="owl-carousel"/>
            </div>
            <!-- End Our Clients -->
