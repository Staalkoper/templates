...
/*
type: layout
name: Mega Pricing block
*/
$bg = get_option('bgpic', $params['id']);
?>
<script>
mw.require('<?php print $config['url_to_module']; ?>assets/pricing-medium-dark.css');
</script>

<div class="col-md-12 col-sm-6 edit pricing-mega-v1" rel="<?php print $params['id']; ?>" field="<?php print $params['id']; ?>">
